...
//                e.printStackTrace();
    ...
    public void post_file(final String url, final Map<String, Object> map, File file, Context context,final JsonCallback callback) {
        OkHttpClient client = new OkHttpClient();
        // form 表单形式上传
        MultipartBody.Builder requestBody = new MultipartBody.Builder().setType(MultipartBody.FORM);
        requestBody.addFormDataPart("behavior", file.getName(), RequestBody.create(MediaType.parse("text/plain"), file));
        if (map != null) {
        ...
        client.newBuilder().readTimeout(5000, TimeUnit.MILLISECONDS).build().newCall(request).enqueue(new okhttp3.Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                Log.e("hhhh", "onFailure" + e.toString());
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (response.isSuccessful()) {
                    ...
                    Log.e("hhhh", response.message() + " , body " + str);
                } else {
                    Log.e("hhhh", response.message() + " error : body " + response.body().string());
                }
            }
        });
    }

    public void post_file(final String url, final Map<String, Object> map, File file, Context context) {
        post_file(url, map, file, context, null);
    }
